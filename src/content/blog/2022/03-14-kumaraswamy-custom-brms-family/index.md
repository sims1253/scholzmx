...
![](../../../../assets/images/blog/2022/03-14-kumaraswamy-custom-brms-family/rng-test-1.png)
...
Show model summary and diagnostics
    ...
    Intercept     0.19      0.02     0.15     0.23 1.00     2427     2495
    a             0.53      0.02     0.50     0.57 1.00     2857     3203

    Further Distributional Parameters:
      Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    p     3.93      0.11     3.71     4.16 1.00     2380     2500

    Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
    and Tail_ESS are effective sample size measures, and Rhat is the potential
    scale reduction factor on split chains (at convergence, Rhat = 1).

![](../../../../assets/images/blog/2022/03-14-kumaraswamy-custom-brms-family/brms-results-1.png)
