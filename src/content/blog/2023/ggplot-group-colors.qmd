...
```{r}
#| label: setup-colors
#| caption: "Setting up named color vectors for meta-groups"
...
```{r}
#| label: scale-manual
#| caption: "Using manual scales with named colors"
...
```{r}
#| label: patchwork-guides
#| caption: "Collecting guides with patchwork"
...
#| caption: "Generating complementary colors using HCL space"
