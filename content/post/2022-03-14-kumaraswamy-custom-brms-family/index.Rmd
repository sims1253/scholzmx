...
*Update:* We finally published [bayesim](https://github.com/sims1253/bayesfam),
...
```{r, log-density-test, warning=FALSE}
layout(matrix(1:3, ncol = 3))
...
```{r, brms-kumaraswamy, warning=FALSE}
a = rnorm(1000)
...
```{r, pp-check, warning=FALSE, message=FALSE}
brms::pp_check(fit1)
```

I would say that looks quite fine. But how about those conditional effects?

```{r, conditional-effects, warning=FALSE}
